...
public class SpikeDetector implements DigitalSensor {
     ...
     */
    public SpikeDetector(AnalogSensor sensor, double spikeThreshold, int numLongReadings, int numShortReadings) {
