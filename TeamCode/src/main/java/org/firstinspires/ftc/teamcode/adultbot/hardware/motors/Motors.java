...
import org.firstinspires.ftc.teamcode.adultbot.util.Function;
...
import org.firstinspires.ftc.teamcode.adultbot.util.StepTimer;
...
public class Motors {
     ...
     */
    public static InputExtractor<Double> powerIE(final Motor motor) {
     ...
     * @return the created InputExtractor
     */
    public static InputExtractor<Motor.Mode> modeIE(final Motor motor) {
        return new InputExtractor<Motor.Mode>() {
            @Override
            public Motor.Mode getValue() {
     ...
     */
    public static Motor combinedWithoutEncoder(final Collection<Motor> motors) {
        return new Motor() {
            @Override
            public void setPower(double power) {
...
//        } while (dcMotor.getMaxSpeed() != maxEncoderTicksPerSecond);
     ...
     * @return the created MotorEnc
     */
    public static MotorEnc scale(final MotorEnc motorEnc, final double scale) {
        return new MotorEnc() {
            @Override
            public void setSpeed(double speed) {
