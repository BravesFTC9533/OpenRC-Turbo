...
public class MecanumMotors extends FourMotors {
     ...
     */
    public MecanumMotors(Motor frontLeftMotor, Motor frontRightMotor, Motor backLeftMotor, Motor backRightMotor, boolean useSpeedMode, Velocity maxRobotSpeed, Velocity maxRobotSpeedSideways) {
